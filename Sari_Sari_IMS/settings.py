...
INSTALLED_APPS = [
    ...
    'dashboard.apps.DashboardConfig',  # Use this format
...
if os.environ.get('DATABASE_URL'):
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.environ.get('DATABASE_NAME', 'sarisari_db'),
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'mark.anthony.alegre05@gmail.com'
EMAIL_HOST_PASSWORD = 'repr aaxo qypp tdet'  # App password
EMAIL_TIMEOUT = 60  # Increased timeout
DEFAULT_FROM_EMAIL = 'mark.anthony.alegre05@gmail.com'
